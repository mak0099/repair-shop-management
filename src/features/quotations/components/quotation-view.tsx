...
export function QuotationView({ quotation }: { quotation: Quotation }) {
  ...
  return (
    <div className="flex flex-col h-full bg-background">
      {/* Action Header */}
      <div className="flex justify-between items-center p-4 border-b print:hidden bg-muted/50 pr-28">
        ...
        <div className="max-w-[800px] mx-auto">
          ...
          <div className="flex justify-between items-start border-b-4 border-foreground pb-8">
            ...
            <div className="text-right space-y-1">
              <h2 className="text-xl font-black text-primary uppercase tracking-widest">ESTIMATE</h2>
              <p className="text-sm font-bold text-foreground">#{quotation.quotationNumber}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-12 py-10">
            <div className="space-y-2">
              <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Quoted To</p>
              <div className="text-sm">
                <p className="font-black text-foreground">{quotation.customerName || quotation.customerId}</p>
              </div>
            </div>
            ...
            <div className="w-72 space-y-2.5">
              ...
              {quotation.totalDiscount > 0 && (
                <div className="flex justify-between text-xs text-muted-foreground">
                  ...
                  <span className="font-bold text-destructive">-{currency} {quotation.totalDiscount.toLocaleString()}</span>
                </div>
              )}
              <div className="flex justify-between text-xs text-muted-foreground">
          ...
          <div className="bg-muted/50 p-6 rounded-xl border space-y-3">
            <h4 className="text-[10px] font-black text-foreground uppercase tracking-widest">Terms & Conditions</h4>
